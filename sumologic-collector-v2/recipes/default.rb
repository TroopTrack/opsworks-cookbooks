...
if File.exists? node['sumologic']['installDir']
    ...
    include_recipe 'sumologic-collector-v2::sumoconf'
    include_recipe 'sumologic-collector-v2::sumojson'
    include_recipe 'sumologic-collector-v2::install'
    include_recipe 'sumologic-collector-v2::cleanup'
end
